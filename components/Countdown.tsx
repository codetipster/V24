...
export function Countdown({ launchAt }: { launchAt?: string }) {
  ...
  return (
    <div aria-live="polite" className="mt-8 flex items-center justify-center gap-4 text-sm">
...
function TimeBlock({ label, value }: { label: string; value: number }) {
  return (
    <div className="min-w-16 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 px-4 py-3 text-center shadow-lg">
      <div className="text-2xl font-bold tabular-nums text-white">{String(value).padStart(2, "0")}</div>
